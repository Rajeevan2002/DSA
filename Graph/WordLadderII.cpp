class Solution {
public:
    void dfs(string src,string &dest,unordered_map<string,vector<string>> &adj,vector<string> &path,vector<vector<string>> &res)
{
    path.push_back(src);
    if(src==dest)
    {
...
vector<vector<string>> findLadders(string beginWord, string endWord, vector<string>& wordList) 
{
    ...
    dfs(beginWord,endWord,child,path,res);
    return res;        
}
};